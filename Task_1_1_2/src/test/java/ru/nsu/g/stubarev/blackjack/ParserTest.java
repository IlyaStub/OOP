...
class ParserTest {
    ...
    void printOpenCard_Player() {
        ...
        String expected = "You revealed card " + card.toString()
                + System.lineSeparator();
        assertEquals(expected, outputStream.toString());
    }
    ...
    void printOpenCard_Dealer() {
        ...
        String expected = "Dealer reveals card "
                + card.toString()
                + System.lineSeparator();
        assertEquals(expected, outputStream.toString());
    }
    ...
    void printOpenHiddenCard() {
        ...
        String expected = "Dealer reveals hidden card " + card.toString()
                + System.lineSeparator();
        assertEquals(expected, outputStream.toString());
    }
    ...
    void printLoser_PlayerLost() {
        ...
        String expected = "You lost the round!" + System.lineSeparator()
                ...
                + "Do you want to stop playing? Enter 1 if yes, 0 if no"
                + System.lineSeparator();
        assertEquals(expected, outputStream.toString());
    }
